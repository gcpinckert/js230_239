...
class Autocomplete {
  ...
  bindEvents() {
    ...
    this.listUI.addEventListener('mousedown', this.selectListItem.bind(this));
  }
  ...
  generateOverlayContent(inputText, match) {
    let end = match.name.substr(inputText.length);
    return inputText + end;
  }
